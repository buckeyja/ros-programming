...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'chapter3' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/buckey/catkin_ws/install/${idir}'.  Ask the maintainer 'Geoffrey Biggs <gbiggs@killbots.net>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/buckey/catkin_ws/install/lib;/home/buckey/catkin_ws/devel/lib;/opt/ros/indigo/lib)
