...
if("TRUE" STREQUAL "TRUE")
  set(chapter3_SOURCE_PREFIX /home/buckey/catkin_ws/src/basics)
  set(chapter3_DEVEL_PREFIX /home/buckey/catkin_ws/devel)
  set(chapter3_INSTALL_PREFIX "")
  set(chapter3_PREFIX ${chapter3_DEVEL_PREFIX})
else()
  set(chapter3_SOURCE_PREFIX "")
  set(chapter3_DEVEL_PREFIX "")
  set(chapter3_INSTALL_PREFIX /home/buckey/catkin_ws/install)
...
if(NOT "/home/buckey/catkin_ws/devel/include " STREQUAL " ")
  set(chapter3_INCLUDE_DIRS "")
  set(_include_dirs "/home/buckey/catkin_ws/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'chapter3' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Geoffrey Biggs <gbiggs@killbots.net>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'chapter3' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/buckey/catkin_ws/src/basics/${idir}'.  Ask the maintainer 'Geoffrey Biggs <gbiggs@killbots.net>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/buckey/catkin_ws/devel/lib;/home/buckey/catkin_ws/devel/lib;/opt/ros/indigo/lib)
...
set(chapter3_EXPORTED_TARGETS "chapter3_generate_messages_cpp;chapter3_generate_messages_lisp;chapter3_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${chapter3_dep}_FOUND)
      find_package(${chapter3_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${chapter3_dep} REQUIRED ${depend_list})
  endif()
...
set(pkg_cfg_extras "chapter3-msg-extras.cmake")
